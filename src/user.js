...
export class User {
    ...
    calculateEducationOffset(gender, education) {
        ...
        switch (education) {
            ...
            case "High School": this.educationOffset = this.data.educationExpecs[this.age - 1][arrOffset + 2]; return;
            case "Some College": this.educationOffset = this.data.educationExpecs[this.age - 1][arrOffset + 3]; return;
